...
import type { LeaveRequest, LeaveBalance, LeaveRequestForm } from "@/types"
...
export const useLeaveStore = defineStore("leave", () => {
    ...
    const totalLeaveDays = computed(() =>
        approvedRequests.value.reduce((total, request) => {
    ...
    const createLeaveRequest = async (leaveData: LeaveRequestForm) => {
        loading.value = true
        error.value = null
    ...
    const updateLeaveRequest = async (id: string, leaveData: Partial<LeaveRequestForm>) => {
        loading.value = true
        error.value = null
